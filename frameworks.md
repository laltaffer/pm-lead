...
| Resolve a pursue into a path | Buy / Build / Partner — a pursued capability can be acquired or partnered for, not only built; buy and partner are usually Type 1 calls, so classify per bet-ledger.md §3 | SKILL.md Stage 2; Pragmatic Framework's Business category, pragmaticinstitute.com |
